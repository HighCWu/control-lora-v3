...
class StableDiffusionXLControlLoraV3Pipeline(
    DiffusionPipeline,
    ...
    r"""
    Pipeline for text-to-image generation using Stable Diffusion XL with extra condition guidance.
    ...
    Args:
        ...
        unet ([`UNet2DConditionModelEx`]):
            A `UNet2DConditionModelEx` to denoise the encoded image latents.
        scheduler ([`SchedulerMixin`]):
    ...
    def lora_state_dict(
        ...
        **kwargs,
        ...
        state_dict, network_alphas = super(StableDiffusionXLControlLoraV3Pipeline, cls).lora_state_dict(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # 7.1 Create tensor stating which extra_conditions to keep
